  ...
  const handleAddSchedule = async () => {
    ...
    try {
      ...
      const requestBody: AddScheduleRequest = {
        ...
        scheduleDateDTOs: [
          {
            startDate: new Date(newSchedule.showDate + 'T00:00:00+00:00').toISOString(),
  ...
  const handleEditSchedule = async () => {
    ...
    try {
      ...
      const requestBody: EditScheduleRequest = {
        ...
        scheduleDate: new Date(editSchedule.showDate + 'T00:00:00+00:00').toISOString(),
      };
          ...
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
            <div className="max-w-lg w-full bg-white/10 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-yellow-500/30">
              ...
              <div className="mt-6 flex justify-center gap-4">
                ...
                >
                  {loading ? <span className="loader"></span> : 'Lưu'}
                </button>
                <button
                  onClick={() => {
                    setShowAddModal(false);
