                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                        {movies.length > 0 ? (
                            movies.map((movie) => (
                                <div
                                    key={movie.movieID}
                                    className="relative group bg-slate-900/80 rounded-2xl shadow-xl overflow-hidden transition-all duration-500 hover:shadow-[0_0_30px_rgba(168,85,247,0.4)] border border-slate-800 cursor-pointer h-[380px]"
                            ...
                            <p className="text-slate-400 text-center col-span-4 text-lg font-medium">Không có phim nào để hiển thị.</p>
                        )}
                    </div>
                </main>
                {/* Trailer Popup */}
